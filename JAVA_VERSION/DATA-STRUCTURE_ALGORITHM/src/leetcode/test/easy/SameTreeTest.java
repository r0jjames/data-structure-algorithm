...
class SameTreeTest {
    ...
    void testIsSameTreeDPS1() {
        ...
        assertTrue(sameTree.isSameTreeDPS(root1, root2));
    }
    @Test
    void testIsSameTreeDPS2() {
        TreeNode root1 = new TreeNode(1);
        root1.left = new TreeNode(2);
        ...
        assertFalse(sameTree.isSameTreeDPS(root1, root2));
    }
    @Test
    void testIsSameTreeDPS3() {
        TreeNode root1 = new TreeNode(1);
        root1.left = new TreeNode(2);
        root1.right = new TreeNode(1);
